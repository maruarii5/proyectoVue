...
async function cargarRoles(){
    ...
    const response = await fetch(
        ...
        "https://proyectovue-production-73f7.up.railway.app/api/roles",
...
async function guardarRegistro(){
    ...
    try{
        ...
        let url="https://proyectovue-production-73f7.up.railway.app/api/roles";
...
async function confirmarEliminar(){
    ...
    try{
        ...
        const response=await fetch(
            ...
            `https://proyectovue-production-73f7.up.railway.app/api/roles/${idEliminar.value}`,
